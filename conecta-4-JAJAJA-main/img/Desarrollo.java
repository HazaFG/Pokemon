...
public class Desarrollo extends JPanel implements ActionListener{
	...
	private int puntosJ1, puntosJ2 ,pt1 =0, pt2 =0;
    public Desarrollo() {
    ...
    public void Ganador() {
    	...
    	JOptionPane.showMessageDialog(null, "Puntos del PRI: "+pt2+"\n\n"+"Puntos del PAN: "+pt1);
    }
			...
			public void actionPerformed(ActionEvent a) {
				...
				if(a.getSource()==botonGanar) {
			       ...
			       // this.setVisible(false);
			        Window w = SwingUtilities.getWindowAncestor(Desarrollo.this);
			        w.setVisible(false);
			}
				}

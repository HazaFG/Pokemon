...
public class ControladorTile {
    ...
    public ControladorTile(Juego aj) {
    ...
    public void cargarTile() {
        try {
            tile[0] = new Tile();
            tile[0].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Arbusto.png"));
            tile[0].colision = true;

            tile[1] = new Tile();
            tile[1].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Tierra.png"));

            tile[2] = new Tile();
            tile[2].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Lodo.png"));

            tile[3] = new Tile();
            tile[3].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Tierra.png"));

            tile[4] = new Tile();
            tile[4].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Hierva.png"));

            tile[5] = new Tile();
            tile[5].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Agua.png"));

            tile[6] = new Tile();
            tile[6].imagen = ImageIO.read(getClass().getResourceAsStream("/img/Vallas.png"));
